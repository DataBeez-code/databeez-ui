...
>(({ className, ...props }, ref) => (
  <thead ref={ref} className={cn("bg-subtle border-b border-border", className)} {...props} />
))
...
>(({ className, ...props }, ref) => (
  <tfoot
    ref={ref}
    className={cn("bg-subtle border-t border-border font-medium", className)}
    {...props}
  />
))
...
>(({ className, ...props }, ref) => (
  <td
    ref={ref}
    className={cn("px-4 py-3 align-middle text-text-base", className)}
    {...props}
  />
))
