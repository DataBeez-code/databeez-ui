...
function m() {
  ...
  function i(o) {
    ...
    }, r = "attribute block constant cycle date dump include max min parent random range source template_from_string", a = {
      beginKeywords: r,
      keywords: { name: r },
      relevance: 0,
      contains: [
    ...
    }, e = "apply autoescape block deprecated do embed extends filter flush for from if import include macro sandbox set use verbatim with";
    return e = e + " " + e.split(" ").map(function(l) {
      return "end" + l;
    }).join(" "), {
      name: "Twig",
      aliases: ["craftcms"],
