import R from "./ui361.mjs";
q.displayName = "js-templates";
q.aliases = [];
function q(A) {
  A.register(R), function(a) {
    var d = a.languages.javascript["template-string"], O = d.pattern.source, h = d.inside.interpolation, C = h.inside["interpolation-punctuation"], E = h.pattern.source;
    function c(t, n) {
      if (a.languages[t])
        return {
          pattern: RegExp("((?:" + n + ")\\s*)" + O),
          lookbehind: !0,
          greedy: !0,
          inside: {
    ...
    function L(t) {
      var n = {};
      n["interpolation-punctuation"] = C;
      var r = a.tokenize(t, n);
      if (r.length === 3) {
        var e = [1, 1];
        e.push.apply(
          e,
          _(r[1], a.languages.javascript, "javascript")
        ), r.splice.apply(r, e);
      }
      return new a.Token(
        "interpolation",
    ...
    function G(t, n, r) {
      var e = a.tokenize(t, {
        ...
        if (typeof o == "string")
          return o;
        for (var s = o.content, i; t.indexOf(
          i = S(l++, r)
        ) !== -1; )
          ;
        return f[i] = s, i;
      ...
      function u(o) {
        for (var s = 0; s < o.length; s++) {
          ...
          if (typeof i == "string" || typeof i.content == "string") {
            var j = y[l], k = typeof i == "string" ? i : (
              /** @type {string} */
              i.content
            ), m = k.indexOf(j);
            if (m !== -1) {
              ++l;
              var w = k.substring(0, m), M = L(
                f[j]
              ), T = k.substring(m + j.length), v = [];
              if (w && v.push(w), v.push(M), T) {
                var x = [T];
                u(x), v.push.apply(v, x);
              }
              typeof i == "string" ? (o.splice.apply(o, [s, 1].concat(v)), s += v.length - 1) : i.content = v;
            }
          } else {
            var z = i.content;
            Array.isArray(z) ? u(z) : u([z]);
          }
        }
      }
      return u(g), new a.Token(
        r,
        g,
        "language-" + r,
        t
