import _ from "./ui357.mjs";
f.displayName = "markdown";
f.aliases = ["md"];
function f(h) {
  h.register(_), function(e) {
    var k = /(?:\\.|[^\\\n\r]|(?:\n|\r\n?)(?![\r\n]))/.source;
    function d(n) {
    ...
    e.languages.markdown = e.languages.extend("markup", {}), e.languages.insertBefore("markdown", "prolog", {
      ...
      function t(r) {
        if (!(!r || typeof r == "string"))
          for (var s = 0, c = r.length; s < c; s++) {
            ...
            var o = i.content[1], a = i.content[3];
            if (o && a && o.type === "code-language" && a.type === "code-block" && typeof o.content == "string") {
              var u = o.content.replace(/\b#/g, "sharp").replace(/\b\+\+/g, "pp");
      ...
      if (n.type === "code-block") {
        for (var t = "", r = 0, s = n.classes.length; r < s; r++) {
          var c = n.classes[r], i = /language-(.+)/.exec(c);
          if (i) {
            t = i[1];
            break;
          }
        ...
        var o = e.languages[t];
        if (o)
          n.content = e.highlight(n.content.value, o, t);
    ...
    }), RegExp(e.languages.markup.tag.pattern.source, "gi"), e.languages.md = e.languages.markdown;
  }(h);
}
export {
  f as default
