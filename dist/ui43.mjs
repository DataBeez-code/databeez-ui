...
import { clamp as Re } from "./ui64.mjs";
import { composeEventHandlers as E } from "./ui48.mjs";
import { createCollection as st } from "./ui65.mjs";
import { useComposedRefs as B } from "./ui56.mjs";
import { createContextScope as lt } from "./ui49.mjs";
import { useDirection as ct } from "./ui53.mjs";
import { DismissableLayer as it } from "./ui57.mjs";
import { useFocusGuards as at } from "./ui60.mjs";
import { FocusScope as dt } from "./ui58.mjs";
import { useId as Ie } from "./ui55.mjs";
import { Anchor as ut, createPopperScope as _e, Content as pt, Root as ft, Arrow as mt } from "./ui66.mjs";
import { Portal as ht } from "./ui59.mjs";
import { Primitive as M } from "./ui52.mjs";
import { createSlot as vt } from "./ui67.mjs";
import { useCallbackRef as gt } from "./ui68.mjs";
import { useControllableState as Ee } from "./ui54.mjs";
import { useLayoutEffect as Y } from "./ui69.mjs";
import { usePrevious as St } from "./ui70.mjs";
import { VISUALLY_HIDDEN_STYLES as wt } from "./ui71.mjs";
import { hideOthers as Ct } from "./ui62.mjs";
import yt from "./ui61.mjs";
...
var xt = [" ", "Enter", "ArrowUp", "ArrowDown"], It = [" ", "Enter"], J = "Select", [ae, de, Tt] = st(J), [te] = lt(J, [
  ...
  return /* @__PURE__ */ m(ft, { ...a, children: /* @__PURE__ */ ce(
    Pt,
    {
      required: R,
      scope: c,
...
var Me = "SelectTrigger", Ae = t.forwardRef(
  (n, c) => {
    ...
    return /* @__PURE__ */ m(ut, { asChild: !0, ...u, children: /* @__PURE__ */ m(
      M.button,
      {
        type: "button",
        role: "combobox",
