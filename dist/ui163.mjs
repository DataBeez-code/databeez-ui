...
function M() {
  ...
  function b(e) {
    const t = e.COMMENT("//", "$", {
    ...
    }), n = "decltype\\(auto\\)", i = "[a-zA-Z_]\\w*::", y = "(" + n + "|" + o(i) + "[a-zA-Z_]\\w*" + o("<[^<>]+>") + ")", s = {
      className: "keyword",
      begin: "\\b[a-z\\d_]*_t\\b"
    }, a = {
      className: "string",
      ...
      className: "title",
      begin: o(i) + e.IDENT_RE,
      relevance: 0
    }, p = o(i) + e.IDENT_RE + "\\s*\\(", r = {
  ...
  function N(e) {
    ...
    return i.keyword += " " + t.keyword, i.literal += " " + t.literal, i.built_in += " " + t.built_in, i._ += " " + t._, n.name = "Arduino", n.aliases = ["ino"], n.supersetOf = "cpp", n;
  }
  return m = N, m;
}
export {
