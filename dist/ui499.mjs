import r from "./ui495.mjs";
import u from "./ui497.mjs";
import i from "./ui357.mjs";
t.displayName = "javadoc";
t.aliases = [];
function t(a) {
  a.register(r), a.register(u), a.register(i), function(e) {
    var n = /(^(?:[\t ]*(?:\*\s*)*))[^*\s].*$/m, o = /#\s*\w+(?:\s*\([^()]*\))?/.source, s = /(?:\b[a-zA-Z]\w+\s*\.\s*)*\b[A-Z]\w*(?:\s*<mem>)?|<mem>/.source.replace(
      /<mem>/g,
      function() {
        return o;
      }
