import c from "./ui357.mjs";
g.displayName = "xquery";
g.aliases = [];
function g(s) {
  s.register(c), function(r) {
    ...
    var o = function(e) {
      ...
      for (var a = [], t = 0; t < e.length; t++) {
        ...
        (!e[t + 1] || e[t + 1].type !== "punctuation" || e[t + 1].content !== "{") && (!e[t - 1] || e[t - 1].type !== "plain-text" || e[t - 1].content !== "{") ? a[a.length - 1].openedBraces++ : a.length > 0 && a[a.length - 1].openedBraces > 0 && n.type === "punctuation" && n.content === "}" ? a[a.length - 1].openedBraces-- : n.type !== "comment" && (u = !0)), (u || typeof n == "string") && a.length > 0 && a[a.length - 1].openedBraces === 0) {
          var i = o(n);
          t < e.length - 1 && (typeof e[t + 1] == "string" || e[t + 1].type === "plain-text") && (i += o(e[t + 1]), e.splice(t + 1, 1)), t > 0 && (typeof e[t - 1] == "string" || e[t - 1].type === "plain-text") && (i = o(e[t - 1]) + i, e.splice(t - 1, 1), t--), /^\s+$/.test(i) ? e[t] = i : e[t] = new r.Token(
            "plain-text",
            i,
            null,
            i
